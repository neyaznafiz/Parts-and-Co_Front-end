    ...
    <div>
      <div className="card lg:w-[500px]  bg-base-100 shadow-xl mx-auto items-center mb-20 bg-transparent">
        <div className="card-body w-full">
          <h2 className="text-center text-2xl font-bold pb-7">
              ...
              <form onSubmit={handleSubmit(handleAddReview)}>
                <div className="form-control  bg-transparent border-0">
                  ...
                  <textarea
                    ...
                    name="yourReview"
                    className="input input-bordered lg:w-[410px] h-[200px] bg-transparent"
                    {...register("review", {
                      required: {
                        value: true,
                ...
                <div className="grid mx-auto">
                  <input
                    type="submit"
                    value="POST REVIEW"
                    className="btn btn-outline w-40 px-3 py-1 mx-auto rounded-md hover:bg-transparent hover:text-black"
                  />
                </div>
              </form>
            </div>
