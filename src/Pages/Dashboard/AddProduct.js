            ...
            <form onSubmit={handleSubmit(handleAddProduct)}>
              <div className="form-control bg-transparent border-0">
                ...
                <input
                  type="email"
                  name="email"
                  className="input input-bordered bg-transparent font-semibold text-lg opacity-75"
                  readOnly
                  value={user?.email}
                  {...register("email", {
                    required: {
              ...
              <div className="form-control bg-transparent border-0">
                ...
                <input
                  ...
                  placeholder="name"
                  name="name"
                  className="input input-bordered bg-transparent font-semibold text-lg"
                  {...register("name", {
                    required: {
                      value: true,
                      message: "name is required",
              ...
              <div className="form-control bg-transparent border-0">
                ...
                <input
                  type="file"
                  name="image"
                  className="form-control h-10 input input-bordered bg-transparent font-semibold text-lg"
                  {...register("img", {
                    required: {
                      value: true,
              ...
              <div className="form-control bg-transparent border-0">
                ...
                <textarea
                  type="text"
                  name="description"
                  className="input input-bordered bg-transparent h-20 font-semibold text-lg"
              ...
              <input
                type="submit"
                value="ADD PRODUCT"
                className="btn btn-outline w-full px-3 py-1 rounded-md hover:bg-transparent hover:text-black"
              />
            </form>
          </div>
        </div>
