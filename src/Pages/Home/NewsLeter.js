...
const NewsLeter = () => {
    return (
        <div className='bg-stone-500'>
            <div className=' relative my-10 py-20 lg:py-40 w-full bg-no-repeat'>

                <div className='text-center'>
                    <h2 className='font-serif text-md lg:text-3xl pb-3 text-slate-300 '>Subscribe and get newsleter about new technologies in every month.</h2>
